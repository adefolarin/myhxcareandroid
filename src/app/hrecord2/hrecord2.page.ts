...
@Component({
  selector: 'app-hrecord2',
  templateUrl: './hrecord2.page.html',
  styleUrls: ['./hrecord2.page.scss'],
})
export class Hrecord2Page implements OnInit {
  ...
  photo: string = "";
  photoname = "Choose a Health Record";
  ...
  async upload() {
    ...
    this.http.post(this.accessserv.server+"hrecord-apicopy.php",formData).subscribe((res:any) => {
        console.log(res);
        if(res.success == true) {
          loader.dismiss();
          this.disabledButton = false;
