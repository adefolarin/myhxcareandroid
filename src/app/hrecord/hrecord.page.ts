...
@Component({
  selector: 'app-hrecord',
  templateUrl: './hrecord.page.html',
  styleUrls: ['./hrecord.page.scss'],
})
export class HrecordPage implements OnInit {
  ...
  async upload() {
    ...
    this.http.post(this.accessserv.server+"hrecord-api.php",formData).subscribe((res:any) => {
        console.log(res);
        if(res.success == true) {
          loader.dismiss();
          this.disabledButton = false;
