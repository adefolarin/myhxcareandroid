...
@Component({
  selector: 'app-healthinfo2',
  templateUrl: './healthinfo2.page.html',
  styleUrls: ['./healthinfo2.page.scss'],
})
export class Healthinfo2Page implements OnInit {
...
/**********   1) Visits Start   **********/ 
  ...
  return new Promise(resolve => {
    ...
    async loadVisitData(myid,hospid) {
      ...
      return new Promise(resolve => {
         ...
         this.accessserv.postData(body2, 'visitsearch-apicopy.php').subscribe((res:any) =>{
            if(res.success == true) {
              //console.log(res.result);
 ...
 async loadAllergyData(myid,hospid) {
  ...
  return new Promise(resolve => {
     let body2 = {
       allergysearch2: "process_allergysearch2",
       myid: myid, 
       mydate: this.mydate,
       mydate2: this.mydate2,
       hospid: hospid,
     ...
     this.accessserv.postData(body2, 'allergysearch-api2.php').subscribe((res:any) =>{
        if(res.success == true) {
          console.log(res.result);
 ...
 /**********   3)  Vaccine Starts **************/
    ...
    this.accessserv.postData(body2, 'vaccinesearch-apicopy.php').subscribe((res:any) =>{
        if(res.success == true) {
          console.log(res.result);
...
this.accessserv.postData(body2, 'testresultsearch-apicopy.php').subscribe((res:any) =>{
    if(res.success == true) {
      console.log(res.result);
 ...
 /**********    Test Result Ends ******************/
  ...
  this.accessserv.postData(body2, 'futuretestsearch-apicopy.php').subscribe((res:any) =>{
      if(res.success == true) {
        console.log(res.result);
 ...
 /**********  Future Ends *********************/
  ...
  this.accessserv.postData(body2, 'statsearch-apicopy.php').subscribe((res:any) =>{
      if(res.success == true) {
        console.log(res.result);
 ...
 /**********  Stat Ends *********************/
  ...
  this.accessserv.postData(body2, 'condsearch-apicopy.php').subscribe((res:any) =>{
      if(res.success == true) {
        console.log(res.result);
 ...
 /**********    Cond Ends **************/
  ...
  this.accessserv.postData(body2, 'prescriptsearch-apicopy.php').subscribe((res:any) =>{
      if(res.success == true) {
        console.log(res.result);
